...
class VRCICal
{
        ...
        if (stristr($lines[0], 'BEGIN:VCALENDAR') === false) {
            ...
            foreach ($lines as $line) {
                ...
                switch ($line) {
                    ...
                    case "BEGIN:VTODO": 
                        $this->todo_count++;
                        $type = __("VTODO", VRCALENDAR_PLUGIN_TEXT_DOMAIN); 
                        break; 

                    case "BEGIN:VEVENT":
                        $this->event_count++;
                        $type = __("VEVENT", VRCALENDAR_PLUGIN_TEXT_DOMAIN); 
                        break;
                    ...
                    case "END:VTIMEZONE": 
                    case "END:STANDARD": 
                        $type = __("VCALENDAR", VRCALENDAR_PLUGIN_TEXT_DOMAIN); 
                        break; 
                    default:
    ...
    {
        $array = $this->cal;
        $events = (isset($array['VEVENT'])) ? $array['VEVENT'] : '';
            ...
            if (isset($anEvent['RRULE']) && $anEvent['RRULE'] != '') {
                ...
                switch ($rrules['FREQ']) {
                    ...
                    case 'WEEKLY':
                        ...
                        $weekdays = array(__('SU', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('MO', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('TU', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('WE', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('TH', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('FR', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('SA', VRCALENDAR_PLUGIN_TEXT_DOMAIN));
                        if(isset($rrules['BYDAY']) && $rrules['BYDAY'] != '') {
                            $bydays = explode(',', $rrules['BYDAY']);
                        } else {
                            $weekTemp = array(__('SU', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('MO', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('TU', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('WE', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('TH', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('FR', VRCALENDAR_PLUGIN_TEXT_DOMAIN),__('SA', VRCALENDAR_PLUGIN_TEXT_DOMAIN));
                    ...
                    case 'MONTHLY':
                        ...
                        if (isset($rrules['BYMONTHDAY']) && $rrules['BYMONTHDAY'] != '') {
                            ...
                            $day_cardinals = array(1 => __('first', VRCALENDAR_PLUGIN_TEXT_DOMAIN), 2 => __('second', VRCALENDAR_PLUGIN_TEXT_DOMAIN), 3 => __('third', VRCALENDAR_PLUGIN_TEXT_DOMAIN), 4 => __('fourth', VRCALENDAR_PLUGIN_TEXT_DOMAIN), 5 => __('fifth', VRCALENDAR_PLUGIN_TEXT_DOMAIN));
                            $weekdays = array('SU' => __('sunday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'MO' => __('monday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'TU' => __('tuesday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'WE' => __('wednesday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'TH' => __('thursday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'FR' => __('friday', VRCALENDAR_PLUGIN_TEXT_DOMAIN),'SA' => __('saturday', VRCALENDAR_PLUGIN_TEXT_DOMAIN));
                            while ($recurring_timestamp <= $until) {
                    ...
                    case 'YEARLY':
                        ...
                        $recurring_timestamp = strtotime($offset, $start_timestamp);
                        $month_names = array(1=> __("January", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 2=>__("Februrary", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 3=>__("March", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 4=>__("April", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 5=>__("May", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 6=>__("June", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 7=>__("July", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 8=>__("August", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 9=>__("September", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 10=>__("October", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 11=>__("November", VRCALENDAR_PLUGIN_TEXT_DOMAIN), 12=>__("December", VRCALENDAR_PLUGIN_TEXT_DOMAIN));
