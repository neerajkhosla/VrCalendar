        ...
        <div class="tabs-content-wrapper">
            <form method="post" action="" >
                ...
                <div id="booking-options" class="tab-content">
                    <?php require(VRCALENDAR_PLUGIN_DIR.'/Admin/Views/Part/AddCalendar/Booking.php'); ?>
                </div>
                ...
                <div id="email-options" class="tab-content">
                        <?php require(VRCALENDAR_PLUGIN_DIR.'/Admin/Views/Part/AddCalendar/emaltemplate.php'); ?>
                    </div>
                <div>
