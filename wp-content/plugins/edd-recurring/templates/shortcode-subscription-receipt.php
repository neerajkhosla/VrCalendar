...
<table id="edd_subscription_receipt">
	...
	<?php foreach ( $subscriptions as $subscription ) :
		...
		<tr>
			...
			<td>
				<span class="edd_subscription_times_billed"><?php echo $subscription->get_total_payments() . ' / ' . ( ( $subscription->bill_times == 0 ) ? __( 'Until cancelled', 'edd-recurring' ) : $subscription->bill_times ); ?></span>
			</td>
			<td>
