...
function updatePrice() {
    ...
    jQuery.post(vrc_data.ajax_url, data, function(response) {
        ...
        {
            rest_of_dates_data = 'Balance of <b>'+price_data.render_currency+''+price_data.remining_price_amount+'</b> will be due in <b>'+price_data.rest_of_days+'</b> days before arrival '+price_data.rest_of_pay_date;
        }
