...
function print_country(country_id,countryname,statename){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	//alert("here country");
	var a = country_arr.indexOf(countryname)
	//alert(a);
	...
	option_str.selectedIndex =a+1;
	if(a)
	{
	print_state('state',a+1,statename)
	}
}

function print_state(state_id, state_index,statename){
	//alert("here state");
	...
	if(statename=="")
	statename="0";
	var b = state_arr.indexOf(statename)
	//alert(b);
	//alert(b+1);
	...
	option_str.selectedIndex = b+1;
	
}
function print_shippingcountry(country_id){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	//alert("here country");
	//var a = country_arr.indexOf(countryname)
	//alert(a);
...
function print_shippingstate(state_id, state_index){
	//alert("here state");
	var option_str = document.getElementById(state_id);
	option_str.length=0;	// Fixed by Julian Woods
	option_str.options[0] = new Option('Select State','');
